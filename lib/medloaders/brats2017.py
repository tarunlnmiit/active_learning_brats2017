...
class MICCAIBraTS2017(Dataset):
    """
    Code for reading the infant brain MICCAIBraTS2017 challenge
    """
    ...
    def __init__(self, args, mode, dataset_path='./datasets', classes=5, crop_dim=(32, 32, 32), split_idx=10,
        ...
        self.training_path = self.root + '/brats2017/train/'
        ...
        self.save_name = self.root + '/brats2017/train/brats2017-list-' + mode + '-samples-' + str(
            samples) + '.txt'
        ...
        self.sub_vol_path = self.root + '/brats2017/train/generated/' + mode + subvol + '/'
        utils.make_dirs(self.sub_vol_path)

        list_IDsT1 = sorted(glob.glob(os.path.join(self.training_path, '*GG/*/Brats*t1.nii.gz')))
        ...
        if self.mode == 'train':
            ...
            self.list = create_sub_volumes(list_IDsT1, list_IDsT1ce, list_IDsT2, list_IDsFlair, labels,
                                           dataset_name="brats2017", mode=mode, samples=samples,
            ...
            self.list_IDsT1 = sorted(glob.glob(os.path.join(self.testing_path, '*GG/*/Brats*t1.nii.gz')))
    ...
    def __getitem__(self, index):
        ...
        if self.mode == 'train' and self.augmentation:
            ...
            return torch.FloatTensor(img_flair.copy()).unsqueeze(0), torch.FloatTensor(img_seg.copy())

        # return (img_t1, img_t1ce, img_t2, img_flair), img_seg
        return img_flair, img_seg
