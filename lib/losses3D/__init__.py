...
from .BCE_dice import BCEDiceLoss, BCEWithLogitsLossPadding
...
SUPPORTED_LOSSES = ['BCEWithLogitsLoss', 'BCEDiceLoss', 'CrossEntropyLoss', 'WeightedCrossEntropyLoss',
                    ...
                    'SmoothL1Loss', 'L1Loss', 'WeightedSmoothL1Loss', 'BCEWithLogitsLossPadding']
...
def create_loss(name, weight=None, ignore_index=None, pos_weight=None):
    ...
    elif name == 'BCEWithLogitsLossPadding':
        return BCEWithLogitsLossPadding()
    else:
